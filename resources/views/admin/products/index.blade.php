...
{{--                            @endcan--}}
{{--                            @can('delete-product')--}}
                                <form style="display: inline-block" action="{{ route('products.destroy', $item->id) }}" id="form-delete{{ $item->id }}"
                                      method="post">
                                    @csrf
                                    @method('delete')
                                ...
                                <button class="btn btn-delete btn-sm btn-danger" data-id={{ $item->id }}>Delete</button>
{{--                        @endcan--}}
                    </tr>
                @endforeach
            </table>
